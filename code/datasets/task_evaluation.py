...
def evaluate_all(dataset, all_boxes, output_dir, test_corloc=False, use_matlab=False):
    """Evaluate "all" tasks, where "all" includes box detection, instance
    segmentation, and keypoint detection.
    """
    all_results = evaluate_boxes(dataset, all_boxes, output_dir,  test_corloc=test_corloc, use_matlab=use_matlab)
...
def evaluate_boxes(dataset, all_boxes, output_dir, test_corloc=False, use_matlab=False):
    ...
    if _use_voc_evaluator(dataset):
        ...
        voc_eval = voc_dataset_evaluator.evaluate_boxes(dataset, all_boxes, output_dir, test_corloc=test_corloc, use_matlab=use_matlab)
...
def _use_voc_evaluator(dataset):
    ...
    ''' ========= Default VOC-type dataset, skip the check ========= '''

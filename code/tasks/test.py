...
def im_detect_bbox(model, im, target_scale, target_max_size, boxes=None):
    ...
    return_dict = model(data,rois,labels,data,rois,labels)
...
if __name__ == '__main__':
    ...
    dataset_mapping = {
        "voc_2007_test": [('voc_2007_test', ), 20],
        "voc_2012_test": [('voc_2012_test', ), 20],
        "voc_2007_trainval": [('voc_2007_trainval', ), 20],
        "voc_2012_trainval": [('voc_2012_trainval', ), 20],
        "clipart_test": [('clipart_test', ), 20],
        "comic_test": [('comic_test', ), 20], # Actually 6 categories, but unified for testing
        "watercolor_test": [('watercolor_test', ), 20], # Actually 6 categories, but unified for testing
    }
    if args.dataset in dataset_mapping.keys():
        cfg.TEST.DATASETS = dataset_mapping[args.dataset][0]

...
from da_model.roi_crop.functions.roi_crop import RoICropFunction
import cv2
import pdb
import random
...
def clip_gradient(model, clip_norm):
    ...
    totalnorm = 0
    for p in da_model.parameters():
        if p.requires_grad and isinstance(p.grad,torch.Tensor):
